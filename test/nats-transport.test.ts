...
test('routes JSON-RPC frames over paired NATS subjects', async () => {
  ...
  assert.deepEqual(JSON.parse(frame.kind === 'text' ? frame.text : ''), { jsonrpc: '2.0', id: 1, result: null });
